...
class WorkerVerificationFlow {
    ...
    async completeOnboarding() {
        ...
        try {
            ...
            Storage.set('karyasetu_user_profile', finalProfile);
            Storage.set('karyasetu_user_role', 'worker');

            // Ensure karyasetu_user exists and marked as loggedIn
            let user = Storage.get('karyasetu_user');
            if (!user) {
                user = {
                    uid: userId,
            ...
            Storage.set('karyasetu_user', user);
